...
from src.sched.scheduler import SpatialGreedyShifting, SpatialShifting
...
RESULT_DIR = (
    Config.get_local_paths()["viz_path"] / "scenarios" / "spatial" / "cpu-greedy"
)
...
def run():
    ...
    main(
        ...
        strat_1=SpatialGreedyShifting(meta_path=META_PATH),
